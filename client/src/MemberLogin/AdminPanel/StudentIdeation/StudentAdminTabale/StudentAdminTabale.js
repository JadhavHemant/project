    ...
    return (
        <>
            <div className='flex items-center justify-center p-3'>
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" onClick={() => AddIdea()}>
                    &#8592; Add Ideation 
                </button>
            </div>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700 text-center">
                                        {
                                            data.map((d, k) => (
                                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                    ...
                                                    <td class="py-3 px-6 text-xs font-medium tracking-wider  text-gray-700 uppercase dark:text-gray-400">{d.student_name}</td>
                                                    <td class="py-3 px-6 text-xs font-medium tracking-wider  text-gray-700 uppercase dark:text-gray-400">{d.student_phone_no}</td>
            ...
            <div className='flex items-center justify-center p-3'>
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" onClick={() => Refrencetable()}>
                    &#8592; Refrence Details
                </button>
            </div>
        </>
